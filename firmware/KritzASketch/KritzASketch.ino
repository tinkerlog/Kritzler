...
void loop() {
  ...
  if (i++ % 1000 == 0) {
    ...
    Serial.print("lift: ");
    Serial.println(digitalRead(LIFT));
  }
  */
  ...
  if (newPosX != posX || newPosY != posY) {
    /*
    Serial.print("x: "); Serial.print(newPosX);
    Serial.print(", y: "); Serial.println(newPosY);
  ...
  Serial.print(", ");
  Serial.print(cmdBuffer[newWritePtr].targetM1);
  Serial.print(", ");
  Serial.println(cmdBuffer[newWritePtr].targetM2);
  */
